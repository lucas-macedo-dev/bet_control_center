                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink v-if="$page.props.auth.user" :href="route('bets.create')"
                                    :active="route().current('bets.create')">
                                    {{ 'Nova Aposta' }}
                                </NavLink>
                                <NavLink v-if="$page.props.auth.user" :href="route('bets.list')"
                                    :active="route().current('bets.list')">
                                    {{ 'Listar Apostas' }}
                                </NavLink>
                                <NavLink v-if="$page.props.auth.user" :href="route('bets.reports')"
                                    :active="route().current('bets.reports')">
                                    {{ 'Relatórios' }}
                                </NavLink>
                            </div>
                        </div>
